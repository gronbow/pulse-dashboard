...
当前公开版本：桌面端与 Codex 插件 v0.5.5 Beta；当前源码：v0.5.6 候选。PR A“训练安全呈现”已在 `codex/pr-a-training-safety` 实现并完成本地验证，尚未合并或发布；PR B“数据可信度呈现”正在隔离分支本地验证，尚未提交、上传或合并。
...
2. 审查 PR B 的逐项日期/来源、文本节点渲染、Handoff `nosniff` 响应头、合成截图与公开说明；获批后再提交、上传和合并。
