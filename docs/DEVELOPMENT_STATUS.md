...
当前版本：桌面端与 Codex 插件 v0.5.5 Beta，公开发布候选准备中
...
| 分发准备 | Windows 打包配置、应用图标、严格包内容白名单、CI、Issue/PR 模板、合成预览图和发布检查清单已加入；v0.5.5 已加入三种简洁小组件截图，并完成隔离目录静默安装/卸载演练。 |
...
4. 完成 v0.5.5 公开分支、Draft PR、Windows 安装包和 Release 资产核验。
